...
<div class="form-group">
    <label class="col-sm-3 control-label" for="seo_meta_tags"><?php echo ('meta_keywords'); ?></label>
    <div class="col-sm-7">
        <div class="form-group">
...
<div class="form-group">
    <label class="col-sm-3 control-label" for="meta_description"><?php echo ('meta_description'); ?></label>
    <div class="col-sm-7">
        <div class="form-group">
