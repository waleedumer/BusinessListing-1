    ...
    <div class="col-sm-offset-3 col-sm-3">
        <div class="col-lg-12">
            <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="general"><i class="fa fa-hotel" style="color: #636363;"></i> <?php echo ('general'); ?></label>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="hotel"><i class="fa fa-hotel" style="color: #636363;"></i> <?php echo ('hotel'); ?> </label>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="restaurant"><i class="fa fa-hotel" style="color: #636363;"></i> <?php echo ('restaurant'); ?></label>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="shop"><i class="fa fa-hotel" style="color: #636363;"></i> <?php echo ('shop'); ?></label>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="beauty"><i class="fa fa-hotel" style="color: #636363;"></i> <?php echo ('beauty'); ?></label>
            </div>
        </div>
    </div>

    <div class="col-sm-3 text-left">
        <a href="#" id = "demo-btn" class="btn btn-primary mt-4" onclick="showListingTypeWiseDemo($('.listing-type-radio').val())"> <i class="mdi mdi-eye"></i> <?php echo ('no_preview_available'); ?> </a>
    </div>
</div>
