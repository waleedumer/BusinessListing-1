                ...
                <div class="col-sm-4">
                    <article class="album">
                        <section class="album-info text-center">
                            ...
                            <div class="label label-info">Rrecommended</div>
                            <?php endif; ?>
                            </p>
                        </section>
                        ...
                        <div class="category-actions text-center">
                            ...
                            ?>
                            <a href="<?php echo url('user/free_package/free/'.$this->session->userdata('user_id').'/'.$package['id'].'/0') ?>" class="btn btn-primary mt-4 mb-2 btn-rounded">Choose plan</a>
                            <?php
                            }
                            }else{
