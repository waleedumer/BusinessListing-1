...
<!--        --><?php //include 'listing_reviews.php'; ?>
        ...
        <aside class="col-lg-4" id="sidebar">
            <div class="box_detail booking">
                ...
                <a href="javascript:" onclick="addToWishList('<?php echo $listing_details['id']; ?>')" class="btn_1 full-width outline wishlist" id = "btn-wishlist"><i class="icon_heart"></i> <?php echo $listing_details->users->first()->pivot->is_wishlisted ? 'Remove from wishlist' : 'Add to wishlist'; ?></a>
