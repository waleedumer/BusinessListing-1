            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-lg-10 col-9">
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $listing_details->reviews->first()['review_rating']/$listing_details->reviews()->count()*100; ?>%" aria-valuenow="{{$listing_details->reviews->first()['review_rating']/$listing_details->reviews()->count()*100}}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
        ...
        <div class="review-box clearfix">
            ...
            <div class="rev-content">
                ...
                <div class="rev-text">
                  ...
                  <a href="javascript: void(0);" onclick="confirm_modal('<?php echo url('admin/review_modify/delete/'.$review['review_id'].'/'.$slug ?? ''.'/'.$listing_id); ?>');" class="text-danger"><i class="icon-trash pb-2"></i></a>
                </span>
