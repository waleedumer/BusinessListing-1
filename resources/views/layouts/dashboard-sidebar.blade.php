<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- Listings -->
        <li class="<?php if ($page_data['page_name'] == 'listings' || $page_data['page_name'] == 'listing_create_wiz' || $page_data['page_name'] == 'listing_edit_wiz' || $page_data['page_name'] == 'reported_listings' || $page_data['page_name'] == 'claimed_listings') echo 'opened active has-sub'; ?>">
            <a href="#">
        ...
        <!-- Blogs -->
        <li class="<?php if ($page_data ['page_name'] == 'blogs' || $page_data['page_name']== 'blogs_create' || $page_data['page_name']== 'blogs_edit') echo 'opened has-sub'; ?>">
            <a href="#">
